...
public final class LanServerDiscovery {
   private static String discoveryRequest = "rs2006sp req";
   public static String discoveryResponsePrefix = "rs2006sp resp";
   public static String serverAddressPrefix = "this is a reserved text for server name";
   ...
   public static void discoverServers() {
      if (!running) {
         try {
            byte[] bytes = discoveryRequest.getBytes();
